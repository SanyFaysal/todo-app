import { DatePicker, Dropdown, Input, Radio, Select, Space } from "antd";
...
export default function Header() {
  ...
  return (
    <div className="py-5 px-3 grid lg:grid-cols-5 justify-items-between bg-white mx-4  rounded mt-2 sticky top-0 border-b-2 border-b-sky-100">
      ...
      <div className="flex gap-3 justify-end mt-2 col-span-3 lg:mr-0  ">
        <Input
          onChange={handleSearchByText}
          size="large"
          className=" border border-gray-300 rounded-lg lg:w-1/2 w-full "
